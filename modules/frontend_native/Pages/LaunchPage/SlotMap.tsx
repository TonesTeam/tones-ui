        ...
        {Array(SLOT_QUANTITY)
          ...
          .map((_, index) => {
            return (
              <TouchableOpacity
                key={index}
                style={[s.slot_box, props.slotsMap[index] == true && s.slot_active_box]}
                onPress={() => {
                  if (
                    props.limitReached == false ||
                    (props.limitReached == true && props.slotsMap[index] == true)
                  ) {
              ...
              >
                ...
                {props.slotsMap[index] == true && (
                  <Slot_Active_Icon height={50} style={s.active_icon} />
                )}
              </TouchableOpacity>
            );
          })}
