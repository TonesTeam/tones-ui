    ...
    <View style={s.container}>
      <View style={s.form_container}>
        <View style={s.form}>
          ...
          >
            <Txt style={{ color: "#fff", textTransform: "uppercase", fontWeight: "800" }}>
              Login
            </Txt>
          </TouchableOpacity>

          <Txt style={{ color: AppStyles.color.text_faded, alignSelf: "center" }}>
      ...
      <LinearGradient
        colors={["transparent", AppStyles.color.secondary, "transparent"]}
        style={s.credits}
        start={[0, 0]}
        end={[1, 1]}
        locations={[0, 0.5, 1]}
