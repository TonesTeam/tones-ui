    ...
    >
      <View
        style={{
          ...
          borderColor: props.isChecked ? AppStyles.color.secondary : AppStyles.color.text_faded,
        }}
      >
        <View
          style={{
      ...
      {props.label && (
        <Txt style={{ fontSize: 16, fontFamily: "Roboto-thin", marginLeft: 10 }}>{props.label}</Txt>
      )}
    </TouchableOpacity>
  );
}
