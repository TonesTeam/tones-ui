...
export class ProcessorMap {
    ...
    public constructor(
        ...
        @inject(ApplyReagentProcessor)
        applyReagentParser: ApplyReagentProcessor,
        @inject(ApplyAntigenProcessor)
        applyAntigenParser: ApplyAntigenProcessor,
        @inject(ApplyWashingProcessor)
        applyWashingProcessor: ApplyWashingProcessor,
        @inject(ApplyBlockingProcessor)
        applyBlockingProcessor: ApplyBlockingProcessor,
        @inject(SetTemperatureProcessor)
        setTemperatureProcessor: SetTemperatureProcessor,
        @inject(ApplyDeparafinizationProcessor)
        applyDeparafinizationProcessor: ApplyDeparafinizationProcessor,
    ) {
