...
describe('Resolve liquid configuration', () => {
    it('Single liquid: [50 10]', () => {
        ...
        const conf = r.resolveLiquidConfiguration([
            new LiquidApplicationCommand(undefined, 1, 50, {
                id: 1,
                isWashing: false,
                isWater: false,
            }),
            new LiquidApplicationCommand(undefined, 1, 10, {
                id: 1,
                isWashing: false,
                isWater: false,
            }),
    ...
    it('2 liquids: [1 2 2], [14 2]', () => {
        const r = new LiquidConfigurationResolver();
        const conf = r.resolveLiquidConfiguration([
            new LiquidApplicationCommand(undefined, 1, 1, {
                id: 1,
                isWashing: false,
                isWater: false,
            }),
            new LiquidApplicationCommand(undefined, 1, 2, {
                id: 1,
                isWashing: false,
                isWater: false,
            }),
            ...
            new LiquidApplicationCommand(undefined, 1, 14, {
                id: 2,
                isWashing: false,
                isWater: false,
            }),
        ...
        const liquidsConf = groupByMapped(
            conf,
            (d) => d.liquidId,
            (d) => d.liquidAmount,
        );
    ...
    it('1 liquid: [25 30 5]', () => {
        const r = new LiquidConfigurationResolver();
        const conf = r.resolveLiquidConfiguration([
            new LiquidApplicationCommand(undefined, 1, 25, {
                id: 1,
                isWashing: false,
                isWater: false,
            }),
            new LiquidApplicationCommand(undefined, 1, 30, {
                id: 1,
                isWashing: false,
                isWater: false,
            }),
            new LiquidApplicationCommand(undefined, 1, 5, {
                id: 1,
                isWashing: false,
                isWater: false,
            }),
