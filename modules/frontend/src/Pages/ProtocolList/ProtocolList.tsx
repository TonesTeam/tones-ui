                ...
                <div className="protocol-body-content">
                    <div>
                        <p>
                            ...
                            adipisicing elit. Placeat, repellendus sit! Cum
                            numquam eveniet vel a hic pariatur quod. Cumque
                            quibusdam magnam odio commodi{' '}
                        </p>
                    </div>
                    ...
                    <div className="protocol-options">
                        <div className="protocol-options">
                            ...
                            <button className="proto-btn">
                                <i className="fas fa-code-branch"></i>Use as
                                template
                            </button>
                        </div>
                        ...
                        <div className="protocol-options">
                            <button
                                className="proto-btn"
                                onClick={() =>
                                    navigate(`/create/protocol/${props.id}`)
                                }
                            >
...
export default function ProtocolList() {
    ...
    const listInitilizer = () => {
        getRequest<ProtocolDto[]>('/protocols').then((r) =>
            setProtocols(r.data),
        );
    };
