...
const protocolsInDB = [] as ProtocolDto[]; //(await getRequest<ProtocolDto[]>("/protocols")).data;
    ...
    return (
        <>
            ...
            <div id="main" className="preparation-wrapper">
                <div id="header">
                    <div id="stage-bar">
                        <div className="stage active" id="s1">
                            <p>Step 1</p>
                        </div>

                        <div
                            className={`stage ${stage >= 1 ? 'active' : ''}`}
                            id="s2"
                        >
                        ...
                        <div
                            className={`stage ${stage >= 2 ? 'active' : ''} `}
                            id="s3"
                        >
                            ...
                            <div id="slot-inp">
                                ...
                                <div className="number-toggle">
                                    <div
                                        ...
                                        style={{
                                            pointerEvents: `${slots == 0 ? 'none' : 'all'}`,
                                        }}
                                    >
                                        -
                                    </div>
                                    ...
                                    <div
                                        ...
                                        style={{
                                            pointerEvents: `${slots == maxSlots ? 'none' : 'all'}`,
                                        }}
                                    >
                                        +
                                    </div>
