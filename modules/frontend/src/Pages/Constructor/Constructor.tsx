...
export default function Constructor() {
    ...
    async function getLiquids() {
        const liquidList = (await getRequest<LiquidDTO[]>('/liquids'))
            .data as LiquidDTO[];
    ...
    const showWorkBlock = (block: StepDTO) => {
        ...
        let button = document.getElementById(
            'cb-' + stepTypeClass.get(block.type),
        );
    ...
    function testSave(blocks: StepDTO[]) {
        const description = (
            document.querySelector(
                'textarea#proto-description',
            )! as HTMLTextAreaElement
        ).value;

        const name = (
            document.querySelector('input#proto_name')! as HTMLInputElement
        ).value;
        ...
        <>
            ...
            <div id="main" className="global-constructor">
                <div id="protocol-meta">
                    ...
                    <button onClick={() => showPreSaveModal(true)}>
                        Save Protocol
                    </button>
                </div>
                <div id="container">
                    ...
                    <div id="timeline">
                        <div className="header">
                            ...
                            <h4 id="duration">
                                Approximate duration: {duration} sec.
                            </h4>
                        </div>
