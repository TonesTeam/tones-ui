                    ...
                    <>
                        <div className="param-row">
                            ...
                            <div className="param-cell">
                                <span>At:</span>
                                <p>
                                    {(block.params as WashStep).temperature}°C
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="param-row">
                            ...
                            <div className="param-cell">
                                <span>For:</span>
                                <p>
                                    {(block.params as WashStep).incubation}{' '}
                                    seconds
                                </p>
                            </div>
                        </div>
                    ...
                    <>
                        <div className="param-row">
                            <div className="param-cell">
                                <span>With:</span>
                                <p>
                                    {(block.params as ReagentStep).liquid.name}
                                </p>
                            </div>
                            <div className="param-cell">
                                <span>At:</span>
                        ...
                        <div className="param-row">
                            <div className="param-cell">
                                <span>For:</span>
                                <p>
                                    {(block.params as ReagentStep).incubation}{' '}
                                    seconds
                                </p>
                            </div>
                            <div className="param-cell">
                                <span>AutoWash:</span>
                                <p>
                                    {(block.params as ReagentStep).autoWash ==
                                    false
                                        ? 'No'
                                        : 'Yes'}
                                </p>
                    ...
                    <>
                        <div className="param-row">
                            <div className="param-cell">
                                ...
                                <p>
                                    {(block.params as TemperatureStep).source}°C
                                </p>
                            </div>
                            <div className="param-cell">
                                <span>To:</span>
                                <p>
                                    {(block.params as TemperatureStep).target}°C
                                </p>
                            </div>
                        </div>
                    </>
