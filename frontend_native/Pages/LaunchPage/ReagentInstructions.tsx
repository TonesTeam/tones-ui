...
export function ReagentInstructions({
    instructions,
    loading,
    protocolId,
}: ReagentInstructionsProps) {
    return (
        <Box
            width={270}
                            ...
                            >
                                <VStack space="sm">
                                    ...
                                    <Text fontSize="$sm" color="$textLight700">
                                        1. Select number of slots to use (top
                                        right corner)
                                    </Text>
                                    <Text fontSize="$sm" color="$textLight700">
                                        2. The tables represent the physical
                                        reagent tray
                                    </Text>
                                    <Text fontSize="$sm" color="$textLight700">
                                        3. Fill tubes with reagents as shown and
                                        place them in corresponding positions
                                    </Text>
                                    <Text fontSize="$sm" color="$textLight700">
                                        4. Match tube positions exactly as
                                        displayed on screen
                                    </Text>
                                </VStack>
                            </Box>
                                ...
                                <Box key={tableIndex}>
                                    ...
                                    {instruction.table === 'Washing liquid' && (
                                        <Text
                                            ...
                                            marginBottom="$3"
                                        >
                                            Ensure that washing liquids are at
                                            least half full. Minimal needed
                                            amount of washing liquid is{' '}
                                            {instruction.reagents[0]?.volume.toFixed(
                                                2,
                                            )}{' '}
                                            ml.
                                        </Text>
                                    ...
                                    {tableIndex < instructions.length - 1 && (
