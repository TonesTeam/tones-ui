...
import { X, Save, Edit3, FlaskConical, Waves, Thermometer, AlertTriangle } from 'lucide-react-native';
...
export default function PreSaveModal({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="xl">
            <ModalBackdrop />
            <ModalContent style={s.modalContent}>
                                    ...
                                    <VStack space="xs">
                                        ...
                                        {isNameEmpty && (
                                            <HStack alignItems="center" space="xs">
                                                <Icon as={AlertTriangle} size="sm" color="$red500" />
                                ...
                                {blocks.length === 0 ? (
                                    ...
                                    >
                                        <VStack alignItems="center" space="md">
                                            <Icon as={FlaskConical} size="xl" color="$textLight400" />
                                            <Text color="$textLight500" textAlign="center">
                                                No steps added yet. Add some steps to your protocol.
                                            </Text>
                                        </VStack>
                                    </Box>
                                ) : (
                                    ...
                                    >
                                        ...
                                        >
                                            <Box flex={0.8}>
                                                <Text fontWeight="$semibold" size="sm" color="$textLight600">
                                                    Step
                                                </Text>
                                            </Box>
                                            <Box flex={1.5}>
                                            ...
                                            {blocks.map((block, index) => {
                                                ...
                                                return (
                                                    <React.Fragment key={index}>
                                                        <HStack 
                                                            p="$3"
                                                            bg={isOdd ? "$backgroundLight50" : "transparent"}
                                                        ...
                                                        >
                                                            ...
                                                            <Box flex={1.5}>
                                                                <HStack alignItems="center" space="xs">
                                                                    <Icon 
                                                                        as={getStepIcon(block.type)} 
                                                                        size="sm"
                                                                        color={
                                                                            block.type === StepType.WASHING ? "$blue500" :
                                                                            "$green500"
                                                                        }
                                                                    />
                                                                    <Text size="sm" color="$textLight900">
                                                                        {getStepTypeName(block.type)}
                                                                    </Text>
                                                                </HStack>
                                                            </Box>
                                                            <Box flex={1.5} justifyContent="center">
                                                                <Text size="sm" color="$textLight900">
                                                            ...
                                                            <Box flex={1.2} justifyContent="center">
                                                                <Text size="sm" color="$textLight900">
                                                                    {settings.timeUnits === 'sec'
                                                                        ...
                                                                        : Math.round(((block.params as WashStep | ReagentStep).incubation / 60) * 100) / 100}
                                                                </Text>
                                                            </Box>
                                                            <Box flex={1} justifyContent="center">
                                                                <Text size="sm" color="$textLight900">
                                                        ...
                                                        {block.type === StepType.LIQUID_APPL &&
                                                            ...
                                                            >
                                                                ...
                                                                <Box flex={1.5}>
                                                                    <HStack alignItems="center" space="xs">
                                                                        <Icon as={Waves} size="sm" color="$blue500" />
                                                                        <Text size="sm" color="$blue600" fontStyle="italic">
                                                                            Auto-washing
                                                                        </Text>
                                                                    </HStack>
                                                                </Box>
